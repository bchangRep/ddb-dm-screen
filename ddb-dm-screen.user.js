            ...
            if (!($(this).parents().hasClass('ddb-campaigns-detail-body-listing-inactive'))) {
                ...
                xmlhttp.onreadystatechange = function() {
                    if (this.readyState == 4 && this.status == 200) {
                        ...
                        var ava1 = spellSlot.available;
                        var used1 = spellSlot.used;
                        ...
                        $('#character-details-'+character.name.replace(/[^0-9a-zA-Z]+/g, '')+' > tbody:last-child').append('<tr><td>----</td><td>'+ '----' + '</td></tr>');
                        $('#character-details-'+character.name.replace(/[^0-9a-zA-Z]+/g, '')+' > tbody:last-child').append('<tr><td>Spell Slots (Level 1):</td><td>'+ ava1 + '</td></tr>');
                        $('#character-details-'+character.name.replace(/[^0-9a-zA-Z]+/g, '')+' > tbody:last-child').append('<tr><td>----</td><td>'+ '----' + '</td></tr>');
